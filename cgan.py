...
from losses import gan_loss_v1, gan_loss_v2
...
class CGAN(object):
    def __init__(self, name, dataset_type, gan_loss_type):
        ...
        self.d_real_logits, _ = network.discriminator(self.real_images, y=self.inputs_y, is_training=True, use_bn=True)
        self.d_fake_logits, _ = network.discriminator(self.fake_images, y=self.inputs_y, is_training=True, use_bn=True)
